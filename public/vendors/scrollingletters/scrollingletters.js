...

{
    ...
    class Entry {
        constructor(el) {
            this.DOM = {el: el};
            this.DOM.image = this.DOM.el.querySelector('.js-scrolling-letters__img');
            this.DOM.title = {word: this.DOM.el.querySelector('.js-scrolling-letters__text')};
    ...
    let current = -1;
    let allentries = [];
    const sections = Array.from(document.querySelectorAll('.js-scrolling-letters__section'));
    // Preload all the images in the page..
	imagesLoaded(document.querySelectorAll('.js-scrolling-letters__img'), () => {
